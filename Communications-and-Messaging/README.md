...
| 3 | [Chat Application](ChatApplication/README.md) | Facade, Observer, Idempotency, Sequencer | Per-conversation seq under a lock, multi-device sessions with sync cursors, delivered/read watermarks, offline push, group admins and join visibility, edits within a window, tombstone deletes, blocking, muting, typing | ✅ 20 tests |
