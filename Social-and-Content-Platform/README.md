...
| 3 | [Learning Platform](LearningPlatform/README.md) | Facade, Sealed types, Ports & Adapters, Observer | Draft/published/archived courses, acyclic prerequisites, sequential unlocking, quizzes with pass marks and attempts, keyed-hash certificates, coupons, payment-first enrollment, refund window and progress cap, honest reviews | ✅ 16 tests |
