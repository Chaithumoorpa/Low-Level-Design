...
| 3 | [Online Stock Exchange](StockExchange/README.md) | Facade, Observer, Price-Time Priority | Per-symbol order books (TreeMap of FIFO levels), limit/market with GTC/IOC/FOK, trades at resting price, self-trade prevention, tick size and price bands, cash/share reservations, modify keeps priority only when shrinking | ✅ 17 tests |
